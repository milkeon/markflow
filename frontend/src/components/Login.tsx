...
export const Login: React.FC<LoginProps> = ({ onBackToHome }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-dark-900 relative overflow-hidden">
      <div className="w-full max-w-md p-8 rounded-2xl border border-brand-500 bg-dark-800/60 backdrop-blur-xl shadow-2xl relative z-level2">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          >
            <div className="w-10 h-10 rounded-xl border border-brand-500 bg-transparent flex items-center justify-center font-bold text-xl text-brand-500 shadow-lg group-hover:scale-105 transition-transform">
              M
            </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full py-3.5 px-4 rounded-xl border border-brand-500 bg-transparent text-brand-500 font-bold hover:bg-brand-500/10 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
          >
            {isRegisterMode ? (
              <>
